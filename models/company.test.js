...
describe("findSome", function () {
    test("works: name filter provided", async function () {
    ...
    test("works: name and emp filters provided", async function () {
        const filters = { name: "c", minEmployees: 2, maxEmployees: 2 };
        let companies = await Company.findSome(filters);
        expect(companies).toEqual([
            {
                handle: "c2",
